...
# this section for learning difference between class based view and function based view as a notes 
# Function based view
...
# class HomeView(View):
#     def get(self, request, *args, **kwargs):
#         return HttpResponse("<h1>Home Page through class view</h1>")


# Class Based View with template render
